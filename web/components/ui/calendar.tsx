  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square size-(--cell-size) rounded-full p-0 text-center select-none [&:last-child[data-selected=true]_button]:rounded-r-full",
        ...
        range_start: cn(
          "relative isolate z-0 rounded-l-full bg-ash-mist after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-ash-mist",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn(
          "relative isolate z-0 rounded-r-full bg-ash-mist after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-ash-mist",
          defaultClassNames.range_end
        ),
        today: cn(
          "rounded-full bg-ash-mist text-foreground data-[selected=true]:rounded-none",
